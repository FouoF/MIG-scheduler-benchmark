...
type Summary struct {
	...
	PhysicalFragmentedGPCMS     int64   `json:"physicalFragmentedGPCMS"`
	StrandedGPCMS               int64   `json:"strandedGPCMS"`
	StrandedGPCTimeRatio        float64 `json:"strandedGPCTimeRatio"`
	FragmentationBlockedGPCMS   int64   `json:"fragmentationBlockedGPCMS"`
	FragmentationBlockedMemMBMS int64   `json:"fragmentationBlockedMemoryMBMS"`
	OfferedGPCMS                int64   `json:"offeredGPCMS"`
	BlockedDemandRatio          float64 `json:"blockedDemandRatio"`
